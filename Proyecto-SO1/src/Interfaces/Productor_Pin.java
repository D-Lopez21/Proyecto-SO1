 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Pin extends javax.swing.JFrame {

    public Productor_Pin() {
        initComponents();
        this.setLocationRelativeTo(null);
        pinDisp.setText(String.valueOf(Productores.pinCargaDisp1));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Productores de Pin de carga");
        ...
        jLabel3.setText("Pin de carga almacenadas");
        ...
        pinDisp.setForeground(new java.awt.Color(255, 255, 255));
        pinDisp.setText("0");
        getContentPane().add(pinDisp, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, -1, -1));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-120, -40, 440, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Pin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Pin().setVisible(true);
            }
        });
    }
