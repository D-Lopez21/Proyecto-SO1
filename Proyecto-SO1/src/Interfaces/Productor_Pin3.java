 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Pin3 extends javax.swing.JFrame {

    public Productor_Pin3() {
        initComponents();
        this.setLocationRelativeTo(null);
        pinDisp.setText(String.valueOf(Productores.pinCargaDisp3));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Pin3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Pin3().setVisible(true);
            }
        });
    }
