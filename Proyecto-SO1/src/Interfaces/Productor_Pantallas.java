 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Pantallas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Pantallas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Pantallas().setVisible(true);
            }
        });
    }
