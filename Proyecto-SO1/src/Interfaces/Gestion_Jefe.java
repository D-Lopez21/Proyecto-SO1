 ...
 * @author Nicolas B
 */
public class Gestion_Jefe extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Gestion_Jefe
     */
    public Gestion_Jefe(int daysToDeliver, int dayDuration, Semaphore mutex) {
        initComponents();
    ...
    public void run(){
        while(!this.stop){
            try{
                ...
                this.daysToDeliver--;
                Empresa1.Dia_entrega.setText(Integer.toString(this.daysToDeliver));
                this.mutex.release();
            }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoNico.jpg"))); // NOI18N
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-140, -60, 370, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gestion_Jefe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestion_Jefe(0, 0, null).setVisible(true);
            }
        });
    }
