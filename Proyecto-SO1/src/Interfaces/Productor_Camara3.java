 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Camara3 extends javax.swing.JFrame {

    public Productor_Camara3() {
        initComponents();
        this.setLocationRelativeTo(null);
        camDisp.setText(String.valueOf(Productores.camarasDisp3));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Camara3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Camara3().setVisible(true);
            }
        });
    }
