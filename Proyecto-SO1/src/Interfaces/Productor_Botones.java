 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Botones extends javax.swing.JFrame {

    public Productor_Botones() {
        initComponents();
        this.setLocationRelativeTo(null);
        botonDisp.setText(String.valueOf(Productores.botonesDisp1));
    }
    ...
    private void initComponents() {
        ...
        botonDisp.setText("0");
        getContentPane().add(botonDisp, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Botones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Botones().setVisible(true);
            }
        });
    }
