 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Camara extends javax.swing.JFrame {

    public Productor_Camara() {
        initComponents();
        this.setLocationRelativeTo(null);
        camDisp.setText(String.valueOf(Productores.camarasDisp1));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 11, -1, -1));
        ...
        camDisp.setText("0");
        getContentPane().add(camDisp, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Camara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Camara().setVisible(true);
            }
        });
    }
