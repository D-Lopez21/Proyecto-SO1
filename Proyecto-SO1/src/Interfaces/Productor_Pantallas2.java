 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Pantallas2 extends javax.swing.JFrame {

    public Productor_Pantallas2() {
        initComponents();
        this.setLocationRelativeTo(null);
        panDisp.setText(String.valueOf(Productores.pantallasDisp2));
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 160, 130, -1));

        prodHired.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        prodHired.setForeground(new java.awt.Color(255, 255, 255));
        prodHired.setText("0");
        getContentPane().add(prodHired, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 60, -1, -1));

        panDisp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        panDisp.setForeground(new java.awt.Color(255, 255, 255));
        panDisp.setText("0");
        getContentPane().add(panDisp, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, -1, -1));

        prodCost.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        prodCost.setForeground(new java.awt.Color(255, 255, 255));
        prodCost.setText("0");
        getContentPane().add(prodCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 160, -1, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoAndres_1.gif"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -30, 460, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Pantallas2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Pantallas2().setVisible(true);
            }
        });
    }
