 ...
 * @author DIEGO_LOPEZ
 */
public class Productor_Camara2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Productores de Cámaras");
        ...
        jLabel3.setText("Cámaras almacenadas");
        ...
        prodHired.setText("0");
        getContentPane().add(prodHired, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, -1, -1));

        camDisp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        camDisp.setForeground(new java.awt.Color(255, 255, 255));
        camDisp.setText("0");
        getContentPane().add(camDisp, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, -1, -1));

        prodCost.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        prodCost.setForeground(new java.awt.Color(255, 255, 255));
        prodCost.setText("0");
        getContentPane().add(prodCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, -1, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoAndres_1.gif"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 0, 450, 220));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productor_Camara2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productor_Camara2().setVisible(true);
            }
        });
    }
